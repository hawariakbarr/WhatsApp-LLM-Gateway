---
name: whatsapp-llm-gateway-agent
version: 1.0.0
enabled: true
---
...
## Overview
Multi-provider LLM gateway with WhatsApp integration

## Providers
| Priority | Provider | Model | Status |
|----------|----------|-------|--------|
| 1 | Anthropic | claude-sonnet-4-5 | ✅ Primary |
| 2 | Google | gemini-2.5-pro | ✅ Backup |
| 3 | XAI | grok-2 | ✅ Backup |
| 4 | DeepSeek | deepseek-chat | ✅ Backup |

## Channels
| Channel | Status | Session |
|---------|--------|---------|
| WhatsApp | ✅ Active | Persistent |
